...
namespace SoftwareLocker
{
    ...
    public class TrialMaker
    {
        ...
        public RunTypes ShowDialog()
        {
            ...
            PassDialog.Text = _SoftName + " " + PassDialog.Text;
        ...
        public int NrDiasFimAvalicao()
        {
            return _DefDays;
        }

        public int NrExecucoesFimAvalicao()
        {
            return _Runed;
        }
